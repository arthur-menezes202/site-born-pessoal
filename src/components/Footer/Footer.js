    ...
    <div className="bg-gray p-7 flex items-center justify-between px-28">
      <div className="flex gap-4">
        <div className="rounded-full bg-[#252525] p-2 cursor-pointer">
          <a href="https://www.linkedin.com/in/arthur-m-correa/" target="_blank">
            <svg
        ...
        <div className="rounded-full bg-[#252525] p-2 cursor-pointer">
          <a href="https://github.com/arthur-menezes202" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
      ...
      <p className="text-gray-2 text-sm">
        © Todos direitos Reservados 2025 - Arthur Menezes
      </p>
    </div>
  </footer>
);
